...
public class ContractProvider {
    ...
    public static final String AUTHORITIES = "content://com.example.contentprovider2.BaseContentProvider";

    public static class Chapitre {
        ...
        public static final Uri URI_CHAPITRE = Uri.parse(AUTHORITIES + "/" + TABLE_CHAPITRE);
    ...
    public static class Person {
        ...
        public static final Uri URI_PERSON = Uri.parse(AUTHORITIES + "/" + TABLE_PERSON);
